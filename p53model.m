function [CancerElementConcentrations] = CancerModel(t, x, c)
...
d_p53p2 = (c(2) * p53g) + (2*c(4) * p53p4) - (c(3) * p53p2 * p53p2) - ...
    (c(6) * p53p2) - (c(29) * mdm2p * p53p2) + (c(30) * mdm2p_p53p2) + ...
    (c(47) * p53p2);
d_p53p4 = (c(3) * p53p2 * p53p2) - (c(7) * p53p4);
...
d_mdm2p = (c(9) * mdm2ma) - (c(16) * mdm2p) - (c(18) * mdm2p * mdm2p) + ...
    (c(17) * mdm2p_mdm2p) - (c(29) * mdm2p * p53p2) + ...
    (c(30) *mdm2p_p53p2) + (c(13) * mdm2mb);
%Note: following equation has delay2 on first term
d_mdm2mb = (c(12) * mdm2gb) - (c(15) * mdm2mb);
d_mdm2p_mdm2p = (c(18) * mdm2p * mdm2p) - (c(19) * mdm2p_mdm2p) - ...
